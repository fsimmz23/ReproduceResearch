...
if (!"stormData.csv.bz2" %in% dir("./data/")) {
    print("hhhh")
    download.file("http://d396qusza40orc.cloudfront.net/repdata%2Fdata%2FStormData.csv.bz2", destfile = "C:/Users/farai/OneDrive/Documents/stormData.csv.bz2")
    bunzip2("C:/Users/farai/OneDrive/Documents/stormData.csv.bz2", overwrite=T, remove=F)
}
```
...
```r
if (!"stormData" %in% ls()) {
    stormData <- read.csv("C:/Users/farai/OneDrive/Documents/stormData.csv", sep = ",")
}
dim(stormData)
```
